...
log = logging.getLogger("kai.stt_server")
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Kai local STT sidecar (faster-whisper)")
    ...
    from kai.media.stt_local import _load_model
