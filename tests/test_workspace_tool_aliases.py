...
class WorkspaceToolAliasesTests(unittest.TestCase):
    ...
    def test_minimal_fixture_resolves_aliases(self) -> None:
        ...
        reload_tool_aliases()
        self.assertEqual(resolve_builtin_id("tenant_site"), "search_official_site")
    ...
    def test_grounded_tools_from_yaml(self) -> None:
        reload_workspace_settings_yaml()
        grounded = reload_grounded_tools()
        self.assertIn("search_faq", grounded)
        self.assertIn("stub_action", grounded)
