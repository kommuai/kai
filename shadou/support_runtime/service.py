...
from shadou.support_runtime.agent_context import assert_prompt_sources_only, build_agent_system_prompt
...
class SupportRuntimeService:
    ...
    def startup(self, *, compile_kb: bool = True, warm_warranty: bool = False) -> dict:
        ...
        if warm_warranty:
            try:
                from shadou.lib.google_sheets import fetch_warranty_all
