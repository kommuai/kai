"""Production turn sampling metrics for Shadou.
...
workspace.yaml knob:
    logging:
        metrics_file: data/turn_metrics.jsonl   # relative to SHADOU_HOME
"""
...
log = logging.getLogger("shadou.metrics")
...
def _metrics_path() -> Path:
    try:
        ...
        return get_settings().shadou_home / rel
