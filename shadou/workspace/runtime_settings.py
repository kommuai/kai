...
from shadou.settings import Settings, get_settings
from shadou.workspace.manifest import load_workspace_data, load_workspace_manifest
...
class RuntimeSettings:
    ...
    def from_sources(cls, settings: Settings, workspace_yaml: dict[str, Any]) -> RuntimeSettings:
        ...
        return cls(
            ...
            agent_max_steps=int(agent.get("max_steps") or settings.shadou_route_agent_max_steps),
            ...
            compile_extra_artifacts=bool(
                ...
                else settings.shadou_compile_extra_artifacts
            ),
