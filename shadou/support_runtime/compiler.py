...
def _compiled_dir() -> Path:
    try:
        ...
        return get_settings().shadou_home / manifest.paths.knowledge_compiled_dir
    except Exception:  # noqa: BLE001
        return get_settings().shadou_home / "compiled"
...
def compile_canonical_knowledge() -> dict[str, int]:
    ...
    if get_settings().shadou_compile_extra_artifacts:
