...
class MediaConfigTests(unittest.TestCase):
    ...
    def _clear_caches(self):
        for fn in (
            ...
            "shadou.media.config.get_media_config",
            "shadou.content.channels.get_channel_config",
        ):
            try:
...
class EnrichVoiceTests(unittest.TestCase):
    ...
    def _clear_caches(self):
        ...
        try:
            ...
            pass
        try:
            from shadou.workspace.manifest import load_workspace_data

            load_workspace_data.cache_clear()
        except Exception:
            pass

    @patch("shadou.media.enrich.transcribe_audio")
