"""Synthetic eval pack generator for Kai.
...
Usage:
    python -m kai.tools.eval_generator [--out PATH] [--compiled-dir PATH]
...
def _default_compiled_dir() -> Path:
    try:
        ...
        return get_settings().kai_home / load_workspace_manifest().paths.knowledge_compiled_dir
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Kai synthetic eval generator")
