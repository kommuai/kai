...
from shadou.content.faq import load_master_faq_text, master_faq_system_block
from shadou.content.loader import manifest_relative_path, read_text_file
...
def assert_prompt_sources_only() -> None:
    """Runtime self-check: FAQ path must resolve under SHADOU_HOME knowledge primary."""
    manifest = load_workspace_manifest()
