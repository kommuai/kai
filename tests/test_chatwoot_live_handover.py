...
class ChatwootLiveHandoverTests(unittest.TestCase):
    ...
    @patch("api.v2.agent_message.enforce_live_agent_handover", return_value=(True, ""))
    @patch("api.v2.agent_message.KAI_CHATWOOT_ENFORCE_LIVE_HANDOVER", "1")
    ...
    @patch("api.v2.agent_message.kai_service.pre_router", return_value=None)
    @patch("api.v2.agent_message.support_runtime_service.execute")
    @patch("api.v2.agent_message.enforce_live_agent_handover", return_value=(False, "toggle_status_failed:500"))
    @patch("api.v2.agent_message.KAI_CHATWOOT_ENFORCE_LIVE_HANDOVER", "1")
