...
class VehicleSupportEvidenceTests(unittest.TestCase):
    @patch("support_runtime.agent_tools._kommu_support_text", return_value="Perodua Myvi (2022-2026 AV) listed with ACC and LKA")
    ...
    @patch("support_runtime.agent_tools.BING_API_KEY", "")
