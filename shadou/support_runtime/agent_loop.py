...
from shadou.support_runtime.guardrails import safety_gate
from shadou.tools_plugins.contract import tool_failure_observation_message
from shadou.support_runtime.models import EvidenceItem, RuntimeResult

log = logging.getLogger("shadou.agent_loop")
