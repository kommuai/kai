...
from shadou.services.container import support_runtime_service  # noqa: E402
...
def main() -> int:
    out_path = Path(sys.argv[1]) if len(sys.argv) > 1 else Path("/tmp/shadou_install_validation_report.json")
    rows: list[dict] = []
